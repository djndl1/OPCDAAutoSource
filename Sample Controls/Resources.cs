...
namespace Opc.Da.SampleClient
{
	...
	public class Resources : System.Windows.Forms.Form
	{
		...
		// global constants
		public static readonly int IMAGE_BROWSE_NODE           = 0;
		public static readonly int IMAGE_SELECTED_BROWSE_NODE  = 1;
		public static readonly int IMAGE_BROWSE_ITEM           = 2;
		public static readonly int IMAGE_ITEM_PROPERTY         = 3;
		public static readonly int IMAGE_REQUEST_NODE          = 4;
		public static readonly int IMAGE_SELECTED_REQUEST_NODE = 5;
		public static readonly int IMAGE_REQUEST               = 6;
		public static readonly int IMAGE_SELECTED_REQUEST      = 7;
		public static readonly int IMAGE_REQUEST_LIST          = 8;
		public static readonly int IMAGE_REQUEST_ITEM          = 9;
