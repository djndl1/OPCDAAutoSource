...
namespace Opc.Da.SampleClient
{
	...
	public class EditArrayDlg : System.Windows.Forms.Form
	{
		...
		private Opc.Da.SampleClient.ValueCtrl ValueCTRL;
		...
		private void InitializeComponent()
		{
			...
			this.ValueCTRL = new Opc.Da.SampleClient.ValueCtrl();
		...
		private new void Update()
		{
			...
			foreach (object element in (Array)m_value)
			{
				...
				ListViewItem item = new ListViewItem(columns, Resources.IMAGE_REQUEST_ITEM);
				item.Tag = element;
